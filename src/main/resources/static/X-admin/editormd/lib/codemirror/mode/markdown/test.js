...
(function() {
  ...
  FT("formatting_linkEmail",
     "[link&formatting&formatting-link <][link userPage@example.com][link&formatting&formatting-link >]");
  ...
  MT("linkEmail",
     "[link <userPage@example.com>] foo");

  MT("linkEmailDouble",
     "[link <userPage@example.com>] foo [link <userPage@example.com>]");
