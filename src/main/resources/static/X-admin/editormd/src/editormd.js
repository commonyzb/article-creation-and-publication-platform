    ...
    editormd.createDialog = function(options) {
        ...
        {                        
            ...
            var userCanSelect = function (obj) {
                obj.removeClass(classPrefix + "userPage-unselect").off("selectstart");
            };

            var userUnselect = function (obj) {
                obj.addClass(classPrefix + "userPage-unselect").on("selectstart", function(event) { // selectstart for IE                        
                    return false;
                });
            };
